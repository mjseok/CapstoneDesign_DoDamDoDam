...
const { selectJournalTeacher, showAllStudent, writeComment, showStudent, addStudent, deleteStudent, updateStudent } = require('../controller/teacherController');

// router.get('/show/journal', selectJournalTeacher);
router.get('/show/class', showAllStudent);
