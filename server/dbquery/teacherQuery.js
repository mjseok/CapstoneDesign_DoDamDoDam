exports.selectJournalTeacher = `SELECT contents, happy, neutral, fear, anger, sadness, main_emotion FROM journal WHERE student_id=? AND date=?`;
...
exports.updateStudent = `UPDATE student SET teacher_id=?, number=?, birth=?, photo=? WHERE id=?`;
